...
namespace Discord.API
{
    internal class DiscordRestApiClient : IDisposable, IAsyncDisposable
    {
            ...
            ClientBucketType clientBucket = ClientBucketType.Unbucketed, RequestOptions options = null)
        {
            ...
            options.BucketId = GetBucketId(method, endpoint);
        ...
        {
            options = RequestOptions.CreateOrClone(options);
            return await SendAsync<GetBotGatewayResponse>("GET", "gateway/bot", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<Channel> CreatePostAsync(ulong channelId, CreatePostParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Channel>("POST", $"channels/{channelId}/threads", args, options: options);
        }
        ...
        public async Task<Channel> CreatePostAsync(ulong channelId, CreateMultipartPostAsync args, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Channel>("POST", $"channels/{channelId}/threads", args.ToDictionary(), options: options);
        }
        ...
        public async Task<Channel> ModifyThreadAsync(ulong channelId, ModifyThreadParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Channel>("PATCH", $"channels/{channelId}", args, options: options);
        }
        ...
        public async Task<Channel> StartThreadAsync(ulong channelId, ulong messageId, StartThreadParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Channel>("POST", $"channels/{channelId}/messages/{messageId}/threads", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Channel> StartThreadAsync(ulong channelId, StartThreadParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Channel>("POST", $"channels/{channelId}/threads", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ChannelThreads> GetActiveThreadsAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<ChannelThreads>("GET", $"guilds/{guildId}/threads/active", options: options);
        }
        ...
        public async Task<ChannelThreads> GetPublicArchivedThreadsAsync(ulong channelId, DateTimeOffset? before = null, int? limit = null, RequestOptions options = null)
        {
            ...
            return await SendAsync<ChannelThreads>("GET", $"channels/{channelId}/threads/archived/public{query}", options: options);
        }
            ...
            RequestOptions options = null)
        {
            ...
            return await SendAsync<ChannelThreads>("GET", $"channels/{channelId}/threads/archived/private{query}", options: options);
        }
            ...
            RequestOptions options = null)
        {
            ...
            return await SendAsync<ChannelThreads>("GET", $"channels/{channelId}/users/@me/threads/archived/private{query}", options: options);
        }
        #endregion
        ...
        public async Task<StageInstance> CreateStageInstanceAsync(CreateStageInstanceParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<StageInstance>("POST", $"stage-instances", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<StageInstance> ModifyStageInstanceAsync(ulong channelId, ModifyStageInstanceParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<StageInstance>("PATCH", $"stage-instances/{channelId}", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<StageInstance> GetStageInstanceAsync(ulong channelId, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<StageInstance>("POST", $"stage-instances/{channelId}", options: options).ConfigureAwait(false);
            }
            catch (HttpException httpEx) when (httpEx.HttpCode == HttpStatusCode.NotFound)
            {
                return null;
        ...
        public async Task ModifyMyVoiceState(ulong guildId, ModifyVoiceStateParams args, RequestOptions options = null)
        {
            ...
            await SendJsonAsync("PATCH", $"guilds/{guildId}/voice-states/@me", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task ModifyUserVoiceState(ulong guildId, ulong userId, ModifyVoiceStateParams args, RequestOptions options = null)
        {
            ...
            await SendJsonAsync("PATCH", $"guilds/{guildId}/voice-states/{userId}", args, options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task AddRoleAsync(ulong guildId, ulong userId, ulong roleId, RequestOptions options = null)
        {
            ...
            await SendAsync("PUT", $"guilds/{guildId}/members/{userId}/roles/{roleId}", options: options).ConfigureAwait(false);
        }
        public async Task RemoveRoleAsync(ulong guildId, ulong userId, ulong roleId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"guilds/{guildId}/members/{userId}/roles/{roleId}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<Message> CreateMessageAsync(ulong channelId, CreateMessageParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Message>("POST", $"channels/{channelId}/messages", args, clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> CreateWebhookMessageAsync(ulong webhookId, CreateWebhookMessageParams args, RequestOptions options = null, ulong? threadId = null)
        {
            ...
            return await SendJsonAsync<Message>("POST", $"webhooks/{webhookId}/{AuthToken}?{WebhookQuery(true, threadId)}", args, clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task ModifyWebhookMessageAsync(ulong webhookId, ulong messageId, ModifyWebhookMessageParams args, RequestOptions options = null, ulong? threadId = null)
        {
            ...
            await SendJsonAsync<Message>("PATCH", $"webhooks/{webhookId}/{AuthToken}/messages/{messageId}?{WebhookQuery(false, threadId)}", args, clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteWebhookMessageAsync(ulong webhookId, ulong messageId, RequestOptions options = null, ulong? threadId = null)
        {
            ...
            await SendAsync("DELETE", $"webhooks/{webhookId}/{AuthToken}/messages/{messageId}?{WebhookQuery(false, threadId)}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> UploadFileAsync(ulong channelId, UploadFileParams args, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Message>("POST", $"channels/{channelId}/messages", args.ToDictionary(), clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> UploadWebhookFileAsync(ulong webhookId, UploadWebhookFileParams args, RequestOptions options = null, ulong? threadId = null)
        {
            ...
            return await SendMultipartAsync<Message>("POST", $"webhooks/{webhookId}/{AuthToken}?{WebhookQuery(true, threadId)}", args.ToDictionary(), clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> ModifyMessageAsync(ulong channelId, ulong messageId, Rest.ModifyMessageParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Message>("PATCH", $"channels/{channelId}/messages/{messageId}", args, clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> ModifyMessageAsync(ulong channelId, ulong messageId, Rest.UploadFileParams args, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Message>("PATCH", $"channels/{channelId}/messages/{messageId}", args.ToDictionary(), clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<Sticker> GetStickerAsync(ulong id, RequestOptions options = null)
        {
            ...
            return await NullifyNotFound(SendAsync<Sticker>("GET", $"stickers/{id}", options: options)).ConfigureAwait(false);
        }
        public async Task<Sticker> GetGuildStickerAsync(ulong guildId, ulong id, RequestOptions options = null)
        {
            ...
            return await NullifyNotFound(SendAsync<Sticker>("GET", $"guilds/{guildId}/stickers/{id}", options: options)).ConfigureAwait(false);
        }
        public async Task<Sticker[]> ListGuildStickersAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<Sticker[]>("GET", $"guilds/{guildId}/stickers", options: options).ConfigureAwait(false);
        }
        public async Task<NitroStickerPacks> ListNitroStickerPacksAsync(RequestOptions options = null)
        {
            options = RequestOptions.CreateOrClone(options);

            return await SendAsync<NitroStickerPacks>("GET", $"sticker-packs", options: options).ConfigureAwait(false);
        }
        public async Task<Sticker> CreateGuildStickerAsync(CreateStickerParams args, ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Sticker>("POST", $"guilds/{guildId}/stickers", args.ToDictionary(), options: options).ConfigureAwait(false);
        }
        public async Task<Sticker> ModifyStickerAsync(ModifyStickerParams args, ulong guildId, ulong stickerId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Sticker>("PATCH", $"guilds/{guildId}/stickers/{stickerId}", args, options: options).ConfigureAwait(false);
        }
        public async Task DeleteStickerAsync(ulong guildId, ulong stickerId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"guilds/{guildId}/stickers/{stickerId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task AddReactionAsync(ulong channelId, ulong messageId, string emoji, RequestOptions options = null)
        {
            ...
            var me = "@me";
            await SendAsync("PUT", $"channels/{channelId}/messages/{messageId}/reactions/{emoji}/{me}", options: options).ConfigureAwait(false);
        }
        public async Task RemoveReactionAsync(ulong channelId, ulong messageId, ulong userId, string emoji, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"channels/{channelId}/messages/{messageId}/reactions/{emoji}/{user}", options: options).ConfigureAwait(false);
        }
        public async Task RemoveAllReactionsAsync(ulong channelId, ulong messageId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"channels/{channelId}/messages/{messageId}/reactions", options: options).ConfigureAwait(false);
        }
        public async Task RemoveAllReactionsForEmoteAsync(ulong channelId, ulong messageId, string emoji, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"channels/{channelId}/messages/{messageId}/reactions/{emoji}", options: options).ConfigureAwait(false);
        }
        public async Task<IReadOnlyCollection<User>> GetReactionUsersAsync(ulong channelId, ulong messageId, string emoji, GetReactionUsersParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<User>>("GET", endpoint, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand[]> GetGlobalApplicationCommandsAsync(bool withLocalizations = false, string locale = null, RequestOptions options = null)
        {
            ...
            return await SendAsync<ApplicationCommand[]>("GET", $"applications/{CurrentApplicationId}/commands{query}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand> GetGlobalApplicationCommandAsync(ulong id, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<ApplicationCommand>("GET", $"applications/{CurrentApplicationId}/commands/{id}", options: options).ConfigureAwait(false);
            }
        ...
        public async Task<ApplicationCommand> CreateGlobalApplicationCommandAsync(CreateApplicationCommandParams command, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand>("POST", $"applications/{CurrentApplicationId}/commands", command, options: options).ConfigureAwait(false);
        }
        public async Task<ApplicationCommand> ModifyGlobalApplicationCommandAsync(ModifyApplicationCommandParams command, ulong commandId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand>("PATCH", $"applications/{CurrentApplicationId}/commands/{commandId}", command, options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteGlobalApplicationCommandAsync(ulong commandId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"applications/{CurrentApplicationId}/commands/{commandId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand[]> BulkOverwriteGlobalApplicationCommandsAsync(CreateApplicationCommandParams[] commands, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand[]>("PUT", $"applications/{CurrentApplicationId}/commands", commands, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand[]> GetGuildApplicationCommandsAsync(ulong guildId, bool withLocalizations = false, string locale = null, RequestOptions options = null)
        {
            ...
            //with_localizations=false doesnt return localized names and descriptions
            var query = withLocalizations ? "?with_localizations=true" : string.Empty;
            return await SendAsync<ApplicationCommand[]>("GET", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands{query}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand> GetGuildApplicationCommandAsync(ulong guildId, ulong commandId, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<ApplicationCommand>("GET", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/{commandId}", options: options);
            }
            catch (HttpException x) when (x.HttpCode == HttpStatusCode.NotFound) { return null; }
        }
        ...
        public async Task<ApplicationCommand> CreateGuildApplicationCommandAsync(CreateApplicationCommandParams command, ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand>("POST", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands", command, options: options).ConfigureAwait(false);
        }
        public async Task<ApplicationCommand> ModifyGuildApplicationCommandAsync(ModifyApplicationCommandParams command, ulong guildId, ulong commandId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand>("PATCH", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/{commandId}", command, options: options).ConfigureAwait(false);
        }
        public async Task DeleteGuildApplicationCommandAsync(ulong guildId, ulong commandId, RequestOptions options = null)
        {
            options = RequestOptions.CreateOrClone(options);

            await SendAsync<ApplicationCommand>("DELETE", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/{commandId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<ApplicationCommand[]> BulkOverwriteGuildApplicationCommandsAsync(ulong guildId, CreateApplicationCommandParams[] commands, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<ApplicationCommand[]>("PUT", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands", commands, options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task CreateInteractionResponseAsync(UploadInteractionFileParams response, ulong interactionId, string interactionToken, RequestOptions options = null)
        {
            ...
            await SendMultipartAsync("POST", $"interactions/{interactionId}/{interactionToken}/callback", response.ToDictionary(), clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        public async Task<Message> GetInteractionResponseAsync(string interactionToken, RequestOptions options = null)
        {
            ...
            return await NullifyNotFound(SendAsync<Message>("GET", $"webhooks/{CurrentApplicationId}/{interactionToken}/messages/@original", options: options)).ConfigureAwait(false);
        }
        public async Task<Message> ModifyInteractionResponseAsync(ModifyInteractionResponseParams args, string interactionToken, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Message>("PATCH", $"webhooks/{CurrentApplicationId}/{interactionToken}/messages/@original", args, options: options);
        }
        public async Task<Message> ModifyInteractionResponseAsync(UploadWebhookFileParams args, string interactionToken, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Message>("PATCH", $"webhooks/{CurrentApplicationId}/{interactionToken}/messages/@original", args.ToDictionary(), options: options);
        }
        public async Task DeleteInteractionResponseAsync(string interactionToken, RequestOptions options = null)
        {
            options = RequestOptions.CreateOrClone(options);

            await SendAsync("DELETE", $"webhooks/{CurrentApplicationId}/{interactionToken}/messages/@original", options: options);
        }
        ...
        public async Task<Message> CreateInteractionFollowupMessageAsync(CreateWebhookMessageParams args, string token, RequestOptions options = null)
        {
            ...
            if (!args.File.IsSpecified)
                return await SendJsonAsync<Message>("POST", $"webhooks/{CurrentApplicationId}/{token}?wait=true", args, options: options).ConfigureAwait(false);
            else
                return await SendMultipartAsync<Message>("POST", $"webhooks/{CurrentApplicationId}/{token}?wait=true", args.ToDictionary(), options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> CreateInteractionFollowupMessageAsync(UploadWebhookFileParams args, string token, RequestOptions options = null)
        {
            ...
            return await SendMultipartAsync<Message>("POST", $"webhooks/{CurrentApplicationId}/{token}?wait=true", args.ToDictionary(), clientBucket: ClientBucketType.SendEdit, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Message> ModifyInteractionFollowupMessageAsync(ModifyInteractionResponseParams args, ulong id, string token, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Message>("PATCH", $"webhooks/{CurrentApplicationId}/{token}/messages/{id}", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteInteractionFollowupMessageAsync(ulong id, string token, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"webhooks/{CurrentApplicationId}/{token}/messages/{id}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<GuildApplicationCommandPermission[]> GetGuildApplicationCommandPermissionsAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<GuildApplicationCommandPermission[]>("GET", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/permissions", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildApplicationCommandPermission> GetGuildApplicationCommandPermissionAsync(ulong guildId, ulong commandId, RequestOptions options = null)
        {
            ...
            return await SendAsync<GuildApplicationCommandPermission>("GET", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/{commandId}/permissions", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildApplicationCommandPermission> ModifyApplicationCommandPermissionsAsync(ModifyGuildApplicationCommandPermissionsParams permissions, ulong guildId, ulong commandId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildApplicationCommandPermission>("PUT", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/{commandId}/permissions", permissions, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<IReadOnlyCollection<GuildApplicationCommandPermission>> BatchModifyApplicationCommandPermissionsAsync(ModifyGuildApplicationCommandPermissions[] permissions, ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildApplicationCommandPermission[]>("PUT", $"applications/{CurrentApplicationId}/guilds/{guildId}/commands/permissions", permissions, options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<Guild> GetGuildAsync(ulong guildId, bool withCounts, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<Guild>("GET", $"guilds/{guildId}?with_counts={(withCounts ? "true" : "false")}", options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound) { return null; }
        }
        ...
        public async Task<GetGuildPruneCountResponse> GetGuildPruneCountAsync(ulong guildId, GuildPruneParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<GetGuildPruneCountResponse>("GET", $"guilds/{guildId}/prune?days={args.Days}{endpointRoleIds}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<IReadOnlyCollection<Ban>> GetGuildBansAsync(ulong guildId, GetGuildBansParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<Ban>>("GET", endpoint, options: options).ConfigureAwait(false);
        }
        public async Task<Ban> GetGuildBanAsync(ulong guildId, ulong userId, RequestOptions options)
        {
            ...
            try
            {
                return await SendAsync<Ban>("GET", $"guilds/{guildId}/bans/{userId}", options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound) { return null; }
        }
        /// <exception cref="ArgumentException">
        ...
        public async Task<GuildWidget> GetGuildWidgetAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            try
            {
                return await SendAsync<GuildWidget>("GET", $"guilds/{guildId}/widget", options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound) { return null; }
        }
        /// <exception cref="ArgumentException"><paramref name="guildId"/> must not be equal to zero.</exception>
        ...
        public async Task<GuildWidget> ModifyGuildWidgetAsync(ulong guildId, Rest.ModifyGuildWidgetParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildWidget>("PATCH", $"guilds/{guildId}/widget", args, options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task DeleteIntegrationAsync(ulong guildId, ulong integrationId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"guilds/{guildId}/integrations/{integrationId}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<InviteVanity> GetVanityInviteAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<InviteVanity>("GET", $"guilds/{guildId}/vanity-url", options: options).ConfigureAwait(false);
        }
        /// <exception cref="ArgumentException"><paramref name="guildId"/> may not be equal to zero.</exception>
        ...
        public async Task<Invite> DeleteInviteAsync(string inviteId, RequestOptions options = null)
        {
            ...
            return await SendAsync<Invite>("DELETE", $"invites/{inviteId}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<GuildMember> AddGuildMemberAsync(ulong guildId, ulong userId, AddGuildMemberParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildMember>("PUT", $"guilds/{guildId}/members/{userId}", args, options: options);
        }
        ...
        public async Task<Role> CreateGuildRoleAsync(ulong guildId, Rest.ModifyGuildRoleParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Role>("POST", $"guilds/{guildId}/roles", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<IReadOnlyCollection<Emoji>> GetGuildEmotesAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<Emoji>>("GET", $"guilds/{guildId}/emojis", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Emoji> GetGuildEmoteAsync(ulong guildId, ulong emoteId, RequestOptions options = null)
        {
            ...
            return await SendAsync<Emoji>("GET", $"guilds/{guildId}/emojis/{emoteId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Emoji> CreateGuildEmoteAsync(ulong guildId, Rest.CreateGuildEmoteParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Emoji>("POST", $"guilds/{guildId}/emojis", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<Emoji> ModifyGuildEmoteAsync(ulong guildId, ulong emoteId, ModifyGuildEmoteParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Emoji>("PATCH", $"guilds/{guildId}/emojis/{emoteId}", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteGuildEmoteAsync(ulong guildId, ulong emoteId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"guilds/{guildId}/emojis/{emoteId}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<GuildScheduledEvent[]> ListGuildScheduledEventsAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<GuildScheduledEvent[]>("GET", $"guilds/{guildId}/scheduled-events?with_user_count=true", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildScheduledEvent> GetGuildScheduledEventAsync(ulong eventId, ulong guildId, RequestOptions options = null)
        {
            ...
            return await NullifyNotFound<GuildScheduledEvent>(SendAsync<GuildScheduledEvent>("GET", $"guilds/{guildId}/scheduled-events/{eventId}?with_user_count=true", options: options)).ConfigureAwait(false);
        }
        ...
        public async Task<GuildScheduledEvent> CreateGuildScheduledEventAsync(CreateGuildScheduledEventParams args, ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildScheduledEvent>("POST", $"guilds/{guildId}/scheduled-events", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildScheduledEvent> ModifyGuildScheduledEventAsync(ModifyGuildScheduledEventParams args, ulong eventId, ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<GuildScheduledEvent>("PATCH", $"guilds/{guildId}/scheduled-events/{eventId}", args, options: options).ConfigureAwait(false);
        }
        ...
        public async Task DeleteGuildScheduledEventAsync(ulong eventId, ulong guildId, RequestOptions options = null)
        {
            ...
            await SendAsync("DELETE", $"guilds/{guildId}/scheduled-events/{eventId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildScheduledEventUser[]> GetGuildScheduledEventUsersAsync(ulong eventId, ulong guildId, int limit = 100, RequestOptions options = null)
        {
            ...
            return await SendAsync<GuildScheduledEventUser[]>("GET", $"guilds/{guildId}/scheduled-events/{eventId}/users?limit={limit}&with_member=true", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<GuildScheduledEventUser[]> GetGuildScheduledEventUsersAsync(ulong eventId, ulong guildId, GetEventUsersParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<GuildScheduledEventUser[]>("GET", endpoint, options: options).ConfigureAwait(false);
        }
        ...
        public async Task<IReadOnlyCollection<UserGuild>> GetMyGuildsAsync(GetGuildSummariesParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<UserGuild>>("GET", $"users/@me/guilds?limit={limit}&after={afterGuildId}", options: options).ConfigureAwait(false);
        }
        ...
        public async Task<AuditLog> GetAuditLogsAsync(ulong guildId, GetAuditLogsParams args, RequestOptions options = null)
        {
            ...
            return await SendAsync<AuditLog>("GET", $"guilds/{guildId}/audit-logs?limit={limit}{queryArgs.ToString()}", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        public async Task<Webhook> CreateWebhookAsync(ulong channelId, CreateWebhookParams args, RequestOptions options = null)
        {
            ...
            return await SendJsonAsync<Webhook>("POST", $"channels/{channelId}/webhooks", args, options: options).ConfigureAwait(false);
        }
        public async Task<Webhook> GetWebhookAsync(ulong webhookId, RequestOptions options = null)
        {
            ...
            {
                if (AuthTokenType == TokenType.Webhook)
                    return await SendAsync<Webhook>("GET", $"webhooks/{webhookId}/{AuthToken}", options: options).ConfigureAwait(false);
                else
                    return await SendAsync<Webhook>("GET", $"webhooks/{webhookId}", options: options).ConfigureAwait(false);
            }
            catch (HttpException ex) when (ex.HttpCode == HttpStatusCode.NotFound) { return null; }
        }
        public async Task<Webhook> ModifyWebhookAsync(ulong webhookId, ModifyWebhookParams args, RequestOptions options = null)
        {
            ...
            if (AuthTokenType == TokenType.Webhook)
                return await SendJsonAsync<Webhook>("PATCH", $"webhooks/{webhookId}/{AuthToken}", args, options: options).ConfigureAwait(false);
            else
                return await SendJsonAsync<Webhook>("PATCH", $"webhooks/{webhookId}", args, options: options).ConfigureAwait(false);
        }
        public async Task DeleteWebhookAsync(ulong webhookId, RequestOptions options = null)
        {
            ...
            if (AuthTokenType == TokenType.Webhook)
                await SendAsync("DELETE", $"webhooks/{webhookId}/{AuthToken}", options: options).ConfigureAwait(false);
            else
                await SendAsync("DELETE", $"webhooks/{webhookId}", options: options).ConfigureAwait(false);
        }
        public async Task<IReadOnlyCollection<Webhook>> GetGuildWebhooksAsync(ulong guildId, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<Webhook>>("GET", $"guilds/{guildId}/webhooks", options: options).ConfigureAwait(false);
        }
        public async Task<IReadOnlyCollection<Webhook>> GetChannelWebhooksAsync(ulong channelId, RequestOptions options = null)
        {
            ...
            return await SendAsync<IReadOnlyCollection<Webhook>>("GET", $"channels/{channelId}/webhooks", options: options).ConfigureAwait(false);
        }
        #endregion
        ...
        private static string CanonizeEndpoint(string endpoint)
        {
        ...
        private static BucketId GetBucketId(string method, string endpoint) {
          var majorParams = new Dictionary<string, string>();
          endpoint = Regex.Replace(endpoint, @"\?.*$", "");
          var match = Regex.Match(endpoint, @"^(channels|guilds|webhooks|interactions)\/(\d{17,19})(.*)");
          if (match.Success)
          {
            var bucketName = match.Groups[1].Value;
            var bucketId = match.Groups[2].Value;
            var remaining = match.Groups[3].Value;
            remaining = CanonizeEndpoint(remaining);
            majorParams.Add(bucketName, bucketId);
            endpoint = $"{bucketName}/{bucketId}{remaining}";
          }
          else
          {
            endpoint = CanonizeEndpoint(endpoint);
          }
          return BucketId.Create(method, endpoint, majorParams);
        }
